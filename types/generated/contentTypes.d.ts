...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    navItems: Schema.Attribute.Component<'navigation.nav-items', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'layout.section', true>;
...
export interface ApiResearchDetailPageResearchDetailPage
  ...
  info: {
    displayName: 'Research detail page';
    pluralName: 'research-detail-pages';
    singularName: 'research-detail-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Duur: Schema.Attribute.Integer;
    Foto: Schema.Attribute.Media<'images' | 'files'>;
    Jaar: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::research-detail-page.research-detail-page'
...
export interface ApiStudentDetailPageStudentDetailPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'student_detail_pages';
  info: {
    displayName: 'Student detail page';
    pluralName: 'student-detail-pages';
    singularName: 'student-detail-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    Onderwijseenheid: Schema.Attribute.Component<
      ...
      false
    >;
    Opleiding: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
        ['HBO-ICT\t', 'CMD\t', 'CO\t', 'CB\t', 'FDND\t', '-']
      > &
      Schema.Attribute.DefaultTo<'[-]'>;
    P5: Schema.Attribute.Text &
      Schema.Attribute.CustomField<
